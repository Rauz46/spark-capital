...
Write-Host "Creating directory: spark-capital-images" -ForegroundColor Yellow
New-Item -ItemType Directory -Force -Path "spark-capital-images" | Out-Null
Set-Location "spark-capital-images"
